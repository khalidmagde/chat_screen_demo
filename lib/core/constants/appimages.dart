class AppImages {
  ...
  static const String albertBell = "$rootImage/albertBell.png";
  static const String darleneSteward = "$rootImage/darleneSteward.png";
  static const String dwightWilson = "$rootImage/dwightWilson.png";
  static const String fullsnackDesigners = "$rootImage/fullsnackDesigners.png";
  static const String gregoryRobertson = "$rootImage/gregoryRobertson.png";
